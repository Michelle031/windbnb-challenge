...
function Nav() {
  ...
  return (
    <div className='w-full h-full bg-[rgba(79,79,79,0.4)] absolute top-0 left-0 text-xs text-[#333333]'>
            ...
            <div onClick={selectPoint} className={`select flex flex-col justify-center px-6 ${points && "active"} `}>
                <p className='text-sm'>LOCATION</p>
                <h3 className='text-xs'>{filter}, Finland</h3>
            </div>
            <div onClick={selectGuest} className={`select flex flex-col justify-center px-6 ${guest && "active"} `}>
            ...
            {points && <div className='flex flex-col space-y-4 pt-3'>
            ...
            {guest && <div className='flex flex-col space-y-4 p-4'>
                <div className="title">
                    <h3>Adults</h3>

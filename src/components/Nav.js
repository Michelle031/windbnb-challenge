...
function Nav() {
  ...
  return (
    <div className='w-full h-full bg-[rgba(79,79,79,0.4)] absolute top-0 left-0 text-xs text-[#333333]'>
            ...
            <div onClick={selectPoint} className={`select flex flex-col justify-center py-2 px-6 ${points && "active"} `}>
                <p className='text-sm'>LOCATION</p>
                <h3 className='text-xs'>{filter}, Finland</h3>
            </div>
            <div onClick={selectGuest} className={`select flex flex-col justify-center py-2 px-6 ${guest && "active"} `}>
